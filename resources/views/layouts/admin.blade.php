...
<head>
  ...
  <title>{{ config('app.name') }}{{ View::yieldContent('title') ? ' - ' . trim(View::yieldContent('title')) : '' }}</title>
...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
    ...
    <x-admin-sidebar :menuItems="[
      ['name' => 'Dashboard', 'icon' => 'nav-icon fas fa-tachometer-alt', 'route' => '#']
    ]" />
